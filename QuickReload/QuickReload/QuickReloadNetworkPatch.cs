...
internal static class QuickReloadNetworkPatch
{
	private static void Postfix(RunManager __instance)
	{
		...
		__instance.NetService.RegisterMessageHandler<QuickReloadMessage>(OnQuickReloadMessage);
		Log.Info($"[QUICKRELOAD]: Registered QuickReloadMessage handler on {__instance.NetService.Type}.");
	}

	private static void OnQuickReloadMessage(QuickReloadMessage message, ulong senderId)
	{
